          ...
          <div className='bg-[#cbcbcb50] px-4 sm:px-6 md:px-10 py-6 sm:py-8 md:py-10'>
            ...
            <form onSubmit={handleSubmit}>
              <div className='flex flex-col gap-4 sm:gap-6 md:gap-8'>
                <input
                  type='text'
                  className='w-full py-2 sm:py-3 bg-gray-100 border border-gray-300 rounded-md text-sm sm:text-base placeholder-gray-500'
                  placeholder='Email'
                />
                <input
                  type='text'
                ...
                />
                <textarea
                  className='w-full h-24 sm:h-32 md:h-36 py-2 sm:py-3 bg-gray-100 border border-gray-300 rounded-md text-sm sm:text-base placeholder-gray-500'
                  placeholder='Message'
                  name='message'
                  id='message'
                ></textarea>
              ...
              <div className='mt-4 sm:mt-6 md:mt-8'>
                <button
                  type='submit'
                  className='bg-red-700 px-6 sm:px-8 md:px-10 py-2 sm:py-3 rounded-md text-white font-medium text-sm sm:text-base'
                >
                  Submit <FontAwesomeIcon icon={faAnglesRight} />
                </button>
              </div>
            </form>
          </div>
          ...
          <div className='w-full pt-4 sm:pt-6 md:pt-8'>
            <div className='flex flex-col gap-6 sm:gap-8 md:gap-10 w-full'>
              <div className='flex flex-col sm:flex-row sm:items-center'>
                <div className='font-medium text-base sm:text-lg md:text-[22px] sm:w-40 text-left'>Regd Office :</div>
                <div className='text-gray-700 text-sm sm:text-base md:text-lg sm:pl-4 md:pl-12'>G-20, Janki Plaza, Jankipuram Ring Road Lucknow</div>
              </div>
              <div className='flex flex-col sm:flex-row sm:items-center'>
                <div className='font-medium text-base sm:text-lg md:text-[19px] sm:w-40 text-left'>Corporate Office :</div>
                <div className='text-gray-700 text-sm sm:text-base md:text-lg sm:pl-4 md:pl-8'>5/573 Vikas Khand Gomti Nagar Lucknow -226010</div>
              </div>
              <div className='flex flex-col sm:flex-row sm:items-center'>
                <div className='font-medium text-base sm:text-lg md:text-[22px] sm:w-40 text-left'>Email Address :</div>
                <div className='text-gray-700 text-sm sm:text-base md:text-lg sm:pl-4 md:pl-8'>info@ftms.co.in</div>
              </div>
              <div className='flex flex-col sm:flex-row sm:items-center'>
                <div className='font-medium text-base sm:text-lg md:text-[22px] sm:w-40 text-left'>Phone Number :</div>
                <div className='text-gray-700 text-sm sm:text-base md:text-lg sm:pl-4 md:pl-8'>0522- 4303131<br />+91 9415341334</div>
              </div>
            </div>
          </div>
        </div>
